# #!/usr/bin/env python3
# """
# Tic-Tac-Toe with an unbeatable AI using Minimax + Alpha-Beta pruning.
...
#         # helper to show indexes 1-9 to the player
#         print("Positions (1-9):")
#         print()
#         print(" 1 | 2 | 3 ")
#         print("---+---+---")
...
#     while True:
#         resp = input(f"{prompt} ({choices_str}){' ['+default+']' if default else ''}: ").strip().lower()
...
# def main():
#     game = TicTacToe()
#     print("✨ Tic-Tac-Toe AI — Minimax + Alpha-Beta (unbeatable) ✨")
#     game.print_positions()

#     while True:
#         game.reset()
#         # pick symbol
#         sym = ask_choice("Pick your symbol", ['x','o'], default='x')
#         human = sym.upper()
#         ai = 'O' if human == 'X' else 'X'

#         # who goes first
#         first = ask_choice("Who goes first? (you/ai/random)", ['you','ai','random'], default='you')
#         if first == 'random':
...
#         # difficulty
#         diff = ask_choice("Difficulty", ['easy','hard'], default='hard')

#         print(f"\nYou are {human}. AI is {ai}. {turn.capitalize()} goes first.\n")
#         game.print_board()
...
#                         idx = move - 1
#                         if game.board[idx] != ' ':
#                             print("That cell is taken. Pick another.")
#                             continue
#                         break
#                     except ValueError:
...
#             else:
#                 # AI turn
#                 print("AI is thinking..." if diff == 'hard' else "AI (easy) picking a move...")
#                 if diff == 'easy':
#                     move = random.choice(game.available_moves())
#                 else:
#                     _, move = game.minimax(0, True, -float('inf'), float('inf'), ai, human)
...
#         again = ask_choice("Play again?", ['y','n','yes','no'], default='y')
#         if again in ('n','no'):
#             print("Peace out ✌️ — thanks for playing.")
#             break
